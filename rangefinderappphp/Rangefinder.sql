...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2019 at 07:38 PM
...
INSERT INTO `item` (`id`, `item_name`, `item_type`, `item_type_id`, `description`, `daily_rate`, `image`, `item_date`) VALUES
(1, 'Tokina Opera 16-28mm F/2.8 FX Zoom Lens for Canon EOS DSLR Cameras\r\n', 'Lens', 1, 'The Tokina Opera 16-28mm F/2.8 FX Zoom Lens is built on a slim housing and utilizes a new DC motor and GMR magnetic AF sensor for quick but quiet autofocusing, while the built-in hood petals provide additional protection to the front element of the lens. The photographer can easily switch between MF and AF mode using Tokina\'s exclusive One-Touch Focus Clutch Mechanism.\r\n', '15.00', '1.jpg', 'Word1'),
(2, 'Rokinon SP 10mm F3.5 Wide Angle Lens for Canon EF Mount with AE (Auto Exposure)\r\n', 'Lens', 1, 'This ultra-wide angle lens provides the widest non-distorted angle of view currently available for Canon full frame sensor cameras. It joins the ROKINON SP 14mm f/2.4, SP 35mm f/1.2, SP 50mm f/1.2, and SP 85mm f/1.2 lenses that are all built to the highest standards with extreme sharpness and premium image quality. \r\n', '18.00', '2.jpg', 'Word2'),
(3, 'Nikon 50mm f/1.8D AF NIKKOR Lens', 'Lens', 1, 'The AF NIKKOR 50mm f/1.8D is as versatile as it is compact—perfect for travel, portraits and general photography. Its fast f/1.8 maxium aperture creates an attractive natural background blur (bokeh) and enables great low-light shooting. Produce consistently stunning visuals, indoors or out.\r\n', '16.00', '3.jpg', 'Word3'),
(4, 'Canon RF 28-70mm f/2 L USM Zoom Lens\r\n', 'Lens', 1, 'The Canon RF 28-70mm f/2L USM provides a unique blend of quality and versatility. With a wide-angle to portrait-length focal range and an impressive constant maximum aperture of f/2, this bright, all-around zoom lens is capable of utilizing faster shutter speeds and delivering professional-quality images for different photography niches like portraiture, landscape, wedding photography, and photojournalism.', '250.00', '4.jpg', 'Word4'),
...
(13, 'Nikon D850 DSLR Camera Body\r\n', 'Camera', 3, 'The D850 puts staggering image quality and impressive performance within reach of working photographers everywhere.At the heart of the D850 is a back-side illuminated (BSI) FX-format full-frame CMOS image sensor with 45.7 megapixels and no optical low-pass filter. \r\n\r\n', '150.00', 'ds3.jpg', 'Word11'),
(14, 'Canon EOS 6D Mark II DSLR Body\r\n', 'Camera', 3, 'The Canon EOS 6D Mark II features a 26.2 Megapixel full-frame CMOS sensor (approx. 35.9mm x 24.0mm) designed to create high-resolution and detailed images. Capable of sensitivities ranging from ISO 100 to ISO 40000 square for outstanding detail and a superb signal-to-noise ratio, resulting in great images. ', '140.00', 'ds4.jpg', 'Word12'),
...
(23, 'Canon EOS C100 Mark II Body \r\n', 'Video Camera', 6, 'The Canon EOS C100 Mark II Cinema Camcorder is a professional video camera with a Super 35mm 8.3MP CMOS sensor and is compatible with Canon\'s line of EF-mount DSLR and cinema lenses. With continuous autofocus and 1080p HD video capture, it is an excellent choice for event videography, documentaries, and independent filmmakers. ', '150.00', 'vc1.jpg', 'Word20'),
...
INSERT INTO `users` (`user_id`, `fname`, `lname`, `postal_code`, `phone`, `email`, `password`, `password2`, `avatar`, `registration_time`) VALUES
(1, 'Tinsel', 'Adams', 'M4C1A1', '4164164646', 'tinsel@email.com', '1111', '1111', 'p1.jpg', '2019-04-09 23:31:33'),
(2, 'Steve\r\n', ' McFurry', 'M3H6A7', '4134145678', 'stevie@email.com', '1111', '1111', 'p2.jpg', '2019-04-09 23:31:33'),
(3, 'Annie', 'Lebowski', 'M4C3C3', '6476476789', 'annie@email.com', '1111', '1111', 'p3.jpg', '2019-04-09 23:31:33');
